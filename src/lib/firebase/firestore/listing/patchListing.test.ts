...
describe('Test patchListing', () => {
    ...
    it('Succesfully call patchListing', async () => {
        const result = await patchListing('listing1', { 'title': 'asdf' });
    ...
    it('patchListing with invalid doc_id', async () => {
        expect(async () => {
            await patchListing('blah', { 'title': 'adsf' });
